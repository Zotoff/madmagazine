...
jquery__WEBPACK_IMPORTED_MODULE_0__(document).ready(function () {
    ...
    var mobileNav = jquery__WEBPACK_IMPORTED_MODULE_0__("#headerMobileNav");
    var mobileMenu = jquery__WEBPACK_IMPORTED_MODULE_0__("#headerMobileMenu");
    var mobileClose = jquery__WEBPACK_IMPORTED_MODULE_0__("#headerMobileClose");
    var mobileSubscribe = jquery__WEBPACK_IMPORTED_MODULE_0__("#headerMobileSubscribe");
    var footerSubscribeForm = jquery__WEBPACK_IMPORTED_MODULE_0__("#footerSubscribe");
    var headerSubscribeButton = jquery__WEBPACK_IMPORTED_MODULE_0__("#headerSubscribeButton");
    var postCommentsLink = jquery__WEBPACK_IMPORTED_MODULE_0__("#postCommentsLink");
    var postCommentsBlock = jquery__WEBPACK_IMPORTED_MODULE_0__("#postComments");
    /* Handle comment like */
    ...
    var commentBlocks = jquery__WEBPACK_IMPORTED_MODULE_0__(".comments__block:not(.comments__block__form)");
    commentBlocks.each(function () {
        ...
        commentItems.each(function () {
            checkCommentLike(jquery__WEBPACK_IMPORTED_MODULE_0__(this));
            jquery__WEBPACK_IMPORTED_MODULE_0__(this).attr("data-commentid", "comment-".concat(generateRandomId(8)));
            jquery__WEBPACK_IMPORTED_MODULE_0__(this).attr("data-commenturl", "./ajax/response.json");
        });
    });
    /* Handle mobile nav */
    ...
    postCommentsLink.on("click", function (evt) {
        evt.preventDefault();
        jquery__WEBPACK_IMPORTED_MODULE_0__('html,body').animate({ scrollTop: jquery__WEBPACK_IMPORTED_MODULE_0__(".comments__filter").offset().top - jquery__WEBPACK_IMPORTED_MODULE_0__('#mainHeader').outerHeight() + 15 }, 500);
    });
    /* Scroll to section function */
    var scrollToSection = function (dataLink) {
        var sectionsWithData = jquery__WEBPACK_IMPORTED_MODULE_0__("section.short-section");
        sectionsWithData.each(function (index, element) {
            var $this = jquery__WEBPACK_IMPORTED_MODULE_0__(this);
            if (dataLink === $this.attr("data-id")) {
                jquery__WEBPACK_IMPORTED_MODULE_0__('html,body').animate({ scrollTop: $this.offset().top - jquery__WEBPACK_IMPORTED_MODULE_0__('#mainHeader').outerHeight() + 15 }, 500);
            }
        });
    };
    /* Handle category nav list click */
    var categoryNavList = jquery__WEBPACK_IMPORTED_MODULE_0__("#categoryNavList li a");
    ...
    /* Comments form */
    var commentsForm = jquery__WEBPACK_IMPORTED_MODULE_0__("#commentsForm");
    var commentsUrl = commentsForm.attr("action");
    if (commentsForm) {
        commentsForm.trigger('reset');
        commentsForm.validate({
            submitHandler: function (form) {
                var comment = jquery__WEBPACK_IMPORTED_MODULE_0__("textarea").val();
                jquery__WEBPACK_IMPORTED_MODULE_0__.ajax({
                    type: "GET",
                    url: commentsUrl,
                    ...
                    console.log(msg);
                    form.reset();
                    var commentMessage = jquery__WEBPACK_IMPORTED_MODULE_0__("#commentMessage");
    ...
    /* Subscribe form */
    var subscribeForm = jquery__WEBPACK_IMPORTED_MODULE_0__("#subscribeForm");
    if (subscribeForm) {
        ...
        subscribeForm.validate({
            submitHandler: function (form) {
                var email = jquery__WEBPACK_IMPORTED_MODULE_0__("#subscribeEmail").val();
                jquery__WEBPACK_IMPORTED_MODULE_0__.ajax({
                    type: "GET",
                    url: subscribeUrl_1,
                    ...
                    console.log(msg);
                    form.reset();
                    var subscribeMessage = jquery__WEBPACK_IMPORTED_MODULE_0__("#subscribeMessage");
    ...
    /* Illustration handle */
    var articleIllustrations = jquery__WEBPACK_IMPORTED_MODULE_0__(".article__illustration");
...
if (articleCarousel) {
    // @ts-ignore
    var slider = (0,tiny_slider_src_tiny_slider__WEBPACK_IMPORTED_MODULE_1__.tns)({
...
if (desktopPromoSlider) {
    // @ts-ignore
    var desktopPromoSlider_1 = (0,tiny_slider_src_tiny_slider__WEBPACK_IMPORTED_MODULE_1__.tns)({
...
if (mobilePromoSlider) {
    // @ts-ignore
    var mobilePromoSlider_1 = (0,tiny_slider_src_tiny_slider__WEBPACK_IMPORTED_MODULE_1__.tns)({
...
if (mainPromoSlider) {
    // @ts-ignore
    var mainPromoSlider_1 = (0,tiny_slider_src_tiny_slider__WEBPACK_IMPORTED_MODULE_1__.tns)({
...
/******/ 	__webpack_require__("./dev/js/modules/jquery.waypoints.min.js");
/******/ 	__webpack_require__("./dev/js/modules/noframework.waypoints.min.js");
/******/ 	__webpack_require__("./dev/js/modules/jquery.fancybox.min.js");
/******/ 	var __webpack_exports__ = __webpack_require__("./dev/js/main.ts");
/******/ 	
/******/ })()
;